// Course CS2820 Authentication Tag: 3JDpgcyvRSHACa+sL04B/x/uY99dtj2cTW/yDf6IjsQ4z+xBWxMSay+oQB2rtaBtNJIXAi/LjI1Uln8jSEND5dsQeQZHGwVjUWoZK+0KdGI=
...
9	sleep	wait(#0)	if !has(F0: B -> C) pull(F0: B -> C, #0) else if !has(F0: B -> C) pull(F0: B -> C, #0) else if !has(F0: B -> C) pull(F0: B -> C, #0)
...
16	sleep	wait(#0)	if has(F1: C -> B) push(F1: C -> B, #0) else if has(F1: C -> B) push(F1: C -> B, #0) else if has(F1: C -> B) push(F1: C -> B, #0)
17	sleep	wait(#0)	if has(F1: C -> B) push(F1: C -> B, #0) else if has(F1: C -> B) push(F1: C -> B, #0) else if has(F1: C -> B) push(F1: C -> B, #0)
...
23	if !has(F1: B -> A) pull(F1: B -> A, #0) else if !has(F1: B -> A) pull(F1: B -> A, #0) else if !has(F1: B -> A) pull(F1: B -> A, #0)	wait(#0)	sleep
24	if !has(F1: B -> A) pull(F1: B -> A, #0) else if !has(F1: B -> A) pull(F1: B -> A, #0) else if !has(F1: B -> A) pull(F1: B -> A, #0)	wait(#0)	sleep
25	if !has(F1: B -> A) pull(F1: B -> A, #0) else if !has(F1: B -> A) pull(F1: B -> A, #0) else if !has(F1: B -> A) pull(F1: B -> A, #0)	wait(#0)	sleep
