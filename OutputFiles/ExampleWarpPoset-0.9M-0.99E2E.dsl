// Course CS2820 Authentication Tag: 3JDpgcyvRSHACa+sL04B//hCQNKhNpt8qQdLGeCrfAFza52SJ+o1MMbBs+ljICCJBEm62IsiBit9ZUaZunSaJsWtyfM+DjajVh3gJ/upWVc=
...
8	sleep	wait(#0)	if !has(F0: B -> C) pull(F0: B -> C, #0) else if !has(F0: B -> C) pull(F0: B -> C, #0) else if !has(F0: B -> C) pull(F0: B -> C, #0)
...
14	sleep	wait(#0)	if has(F1: C -> B) push(F1: C -> B, #0) else if has(F1: C -> B) push(F1: C -> B, #0) else if has(F1: C -> B) push(F1: C -> B, #0)
15	sleep	wait(#0)	if has(F1: C -> B) push(F1: C -> B, #0) else if has(F1: C -> B) push(F1: C -> B, #0) else if has(F1: C -> B) push(F1: C -> B, #0)
...
20	if !has(F1: B -> A) pull(F1: B -> A, #0) else if !has(F1: B -> A) pull(F1: B -> A, #0) else if !has(F1: B -> A) pull(F1: B -> A, #0)	wait(#0)	sleep
21	if !has(F1: B -> A) pull(F1: B -> A, #0) else if !has(F1: B -> A) pull(F1: B -> A, #0) else if !has(F1: B -> A) pull(F1: B -> A, #0)	wait(#0)	sleep
