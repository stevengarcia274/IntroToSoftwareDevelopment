// Course CS2820 Authentication Tag: 3JDpgcyvRSHACa+sL04B/yCejZNKXoWSdHu9fTaaOiE4z+xBWxMSay+oQB2rtaBtyfbXFjeyq3SKZHihe1nmxVDc8f0pfBDHX1M4/RsJvp8=
...
8	wait(#0)	if !has(F0: A -> B) pull(F0: A -> B, #0) else if !has(F0: A -> B) pull(F0: A -> B, #0) else if has(F0: B -> C) push(F0: B -> C, #0)	wait(#0)
9	wait(#0)	if !has(F0: A -> B) pull(F0: A -> B, #0) else if has(F0: B -> C) push(F0: B -> C, #0) else if has(F0: B -> C) push(F0: B -> C, #0)	wait(#0)
...
17	sleep	if has(F0: B -> C) push(F0: B -> C, #0)	wait(#0)
18	sleep	if !has(F1: C -> B) pull(F1: C -> B, #0)	wait(#0)
...
26	wait(#0)	if !has(F1: C -> B) pull(F1: C -> B, #0) else if !has(F1: C -> B) pull(F1: C -> B, #0) else if has(F1: B -> A) push(F1: B -> A, #0)	wait(#0)
27	wait(#0)	if !has(F1: C -> B) pull(F1: C -> B, #0) else if has(F1: B -> A) push(F1: B -> A, #0) else if has(F1: B -> A) push(F1: B -> A, #0)	wait(#0)
...
30	wait(#0)	if has(F1: B -> A) push(F1: B -> A, #0) else if has(F1: B -> A) push(F1: B -> A, #0) else if has(F1: B -> A) push(F1: B -> A, #0)	sleep
...
35	wait(#0)	if has(F1: B -> A) push(F1: B -> A, #0)	sleep
